...
data = np.loadtxt('/home/xileli/Documents/program/CascadeCNN/result/record-cpu.txt')
...
data = np.loadtxt('/home/xileli/Documents/program/CascadeCNN/result/record-gpu.txt')
x = np.linspace(0, 30, data.size)
data_mean = [np.mean(data) for i in x]
with plt.style.context('ggplot'):
